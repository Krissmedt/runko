...
void pic::VerletVelPusher<D,V>::push_container(
...
template class pic::VerletVelPusher<1,3>; // 1D3V
template class pic::VerletVelPusher<2,3>; // 2D3V
template class pic::VerletVelPusher<3,3>; // 3D3V
